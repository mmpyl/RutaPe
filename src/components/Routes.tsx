...
import { Route, Driver, Order } from '../types';
import Map from './Map';
        ...
        <div className={`${showFullMap ? 'hidden lg:block lg:col-span-4' : 'lg:col-span-12'} space-y-6`}>
          <div className={`${showFullMap ? 'grid grid-cols-1' : 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'} gap-6`}>
            {routes.map((r) => {
              ...
              return (
                <div key={r.id} className="bg-white rounded-[32px] border border-slate-100 shadow-sm overflow-hidden flex flex-col hover:shadow-md transition-shadow">
                        ...
                        return (
                          ...
                          >
                            <div className="flex flex-col items-center gap-1 mt-1">
                              ...
                              {idx < r.stops.length - 1 && <div className="w-0.5 h-6 bg-slate-100" />}
                            </div>
